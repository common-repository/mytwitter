<?php /*
Name: Elitwee
Description: Object-oriented PHP classes for accessing the Twitter API and caching JSON responses
...
define('ELITWEE_VERSION','1.4');
define('ELITWEE_RELEASE_DATE','July 20, 2009');
define('ELITWEE_URL','http://calvinf.com/elitwee/');
define('ELITWEE_AUTHOR_NAME','Calvin Freitas');
define('ELITWEE_AUTHOR_URL','http://calvinf.com/');
...
// The constructor
	...
	public function get_search_feed_url() {
		return 'http://search.twitter.com/search.atom?q=from%3A' . $this->username;
	}
	...
	public function authenticated() {
		...
		if(isset($result)) {
			...
			if(isset($array)) {return 1;} //authorized is bool via twitter api
		}
		return false;
	}
